...
class Song:
    ...
    def add_synthesized_midi_path(self, synthesized_midi_path):
        self.full_synthesized_midi_paths.append(FileHandler.get_full_synthesized_midi_path(synthesized_midi_path))

    def add_tab_path(self, tab_path):
        self.full_tab_paths.append(FileHandler.get_full_tab_path(tab_path))

    def add_aligned_midi(self, midi, score):
        self.aligned_midis.append((midi, score))
